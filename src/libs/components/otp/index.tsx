            ...
            <div className="w-full h-full">
                <div className="w-full h-full p-10 flex flex-col items-center justify-center bg-gray-50">
                    ...
                    <div className="w-2/6 flex flex-col gap-4">
                        <input onChange={(e) => setEmail(e.target.value)} type="text" placeholder="Email" className="outline-none w-full p-4 border-2 rounded-lg border-gray-200 shadow bg-white" />
